...
namespace ClinicServiceNamespace
{
    ...
    public partial class ClinicServiceClient 
    {
        ...
        public async System.Threading.Tasks.Task<int> Delete3Async(int? doctorId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (doctorId != null) 
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("doctorId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(doctorId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<Doctor>>(response_, headers_).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Doctor>(response_, headers_).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public async System.Threading.Tasks.Task<int> Delete5Async(int? treatmentId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (treatmentId != null) 
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("treatmentId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(treatmentId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Treatment>(response_, headers_).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    {
        [Newtonsoft.Json.JsonProperty("treatmentId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
